...
export async function generateMetadata() {
    const resp = await getApiData("latest-opening-shop-page");
...
const LatestOpenings = async () => {
    ...
    const brands = await getApiData("shopLatestBrands");
    const getPageData = await getApiData("latest-opening-shop-page")
